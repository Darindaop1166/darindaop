...
TOKEN = '7218517040:AAHUz8aUKliq2JbIEa6cubapd8sKs5kv6q8'
...
def handle_message(message):
    if message.text == "Instant Plan 🍌":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/noobiostg/8142*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*Contact admin @TFN_NOOB_XD*", parse_mode='Markdown')
    else:
